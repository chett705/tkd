...
$icons = [
    ...
    'server'             => '<rect x="2" y="2" width="20" height="8" rx="2"/><rect x="2" y="14" width="20" height="8" rx="2"/><path stroke-linecap="round" d="M6 6h.01M6 18h.01"/>',
    ...
    'badge-check'        => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/>',
    ...
    'photograph'         => '<path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>',
    'exclamation'        => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"/>',
...
$svg = $icons[$icon] ?? $icons['document'];
@endphp

<div class="rounded-xl border border-white/5 bg-[#1a1a2e] overflow-hidden">
    {{-- Section header --}}
    <div class="flex items-center gap-3 px-5 py-3.5 border-b border-white/5 bg-white/2">
        <svg class="w-4 h-4 text-orange-400 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
            {!! $svg !!}
        </svg>
        <h3 class="text-sm font-semibold text-white">{{ $title }}</h3>
    </div>
    {{-- Section body --}}
    <div class="px-5 py-4 text-xs text-gray-400 leading-relaxed">
        {{ $slot }}
    </div>
</div>
